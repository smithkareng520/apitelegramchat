...
TELEGRAM_BOT_TOKEN = os.getenv("TELEGRAM_BOT_TOKEN", "REDACTED_TELEGRAM_BOT_TOKEN")
...
XAI_API_KEY = os.getenv("XAI_API_KEY", "REDACTED_XAI_API_KEY")

WEBHOOK_URL = os.getenv("WEBHOOK_URL", "https://api.render.com/deploy/srv-cvjnao95pdvs739sq12g?key=1gP12PUYEuY/webhook")
